...
import GoogleSignInButton from '@ee/components/GoogleSignInButton'
import PasswordInput from '@/components/auth/PasswordInput'
import PhoneCaptchaDialog from '@ee/components/PhoneCaptchaDialog'
import PhoneNumberInput from '@ee/components/PhoneNumberInput'
import WechatOfficialAuthButton from '@ee/components/WechatOfficialAuthButton'
...
} from '@ee/auth/phone-auth-contract'
...
import { normalizePhoneNumberForDestination } from '@ee/auth/phone-number'
import type { SmsDestinationId } from '@ee/auth/sms-destinations'
