...
import { consumeAvailableCreditsInTransaction } from '@/lib/billing/ledger'
import { llmUsageFactSchema, type LlmUsageFact } from '@/lib/billing/llm-usage'
...
import type {
  ...
  RealtimeLlmSettlementResult,
} from '@/lib/edition/contracts/billing'
 ...
 */
export async function settleRealtimeLlmUsage(
