...
import {
  consumeImageCaptcha,
  ImageCaptchaError,
} from '@ee/auth/image-captcha'
import { PHONE_AUTH_RESULT_CODES } from '@ee/auth/phone-auth-contract'
import {
  PhoneVerificationError,
  requirePhoneAuthEnabled,
  sendPhoneVerificationCode,
} from '@ee/auth/phone-verification'
...
export const handleAuthPhoneSendCodePost = apiHandler(async (request: NextRequest) => {
  try {
    requirePhoneAuthEnabled()
  } catch (error) {
