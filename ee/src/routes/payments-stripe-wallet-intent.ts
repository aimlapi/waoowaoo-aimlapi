...
} from '@ee/payments/stripe-wallet-intent'
import { STRIPE_WALLET_METHOD_IDS } from '@ee/payments/stripe-wallet-methods'
 ...
 */
export const handlePaymentsStripeWalletIntentPost = apiHandler(async (request: NextRequest) => {
