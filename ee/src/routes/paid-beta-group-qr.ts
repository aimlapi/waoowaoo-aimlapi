...
import { userHasPaidBetaGroupAccess } from '@ee/paid-beta/campaign'
import { readPaidBetaGroupQr } from '@ee/paid-beta/group-qr'

export const runtime = 'nodejs'

export const handlePaidBetaGroupQrGet = apiHandler(async () => {
