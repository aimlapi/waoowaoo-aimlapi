...
import {
  ...
  WaoSsoProtocolError,
} from '@ee/auth/sso/service'
import { readWaoSsoProviderBaseUrl } from '@ee/auth/sso/client-registry'
...
export const handleAuthSsoAuthorizeGet = apiHandler(async (request: NextRequest) => {
  let authorization
  try {
