...
import { createWechatOfficialAttempt } from '@ee/auth/wechat-official-attempt'
import {
  WECHAT_OFFICIAL_RESULT_CODES,
  WechatOfficialError,
} from '@ee/auth/wechat-official-config'
import {
...
export const handleAuthWechatAttemptPost = apiHandler(async (request: NextRequest) => {
