...
import { processWechatOfficialScan } from '@ee/auth/wechat-official-attempt'
import { readWechatOfficialConfig, WechatOfficialError } from '@ee/auth/wechat-official-config'
import {
...
} from '@ee/auth/wechat-official-crypto'
import { wechatOfficialReplyMessage } from '@ee/auth/wechat-official-messages'
...
export const handleAuthWechatCallbackGet = apiHandler(async (request: NextRequest) => {
  try {
...
export const handleAuthWechatCallbackPost = apiHandler(async (request: NextRequest) => {
  try {
    const config = readWechatOfficialConfig()
