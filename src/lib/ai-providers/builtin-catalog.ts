...
import { CC_API_CONFIG_CATALOG_MODELS, CC_BUILTIN_CAPABILITY_CATALOG_ENTRIES, CC_BUILTIN_PRICING_CATALOG_ENTRIES } from '@/lib/ai-providers/cc/models'
...
export const BUILTIN_CAPABILITY_CATALOG_ENTRIES = [
  ...
  ...CC_BUILTIN_CAPABILITY_CATALOG_ENTRIES,
...
export const BUILTIN_PRICING_CATALOG_ENTRIES = [
  ...
  ...CC_BUILTIN_PRICING_CATALOG_ENTRIES,
