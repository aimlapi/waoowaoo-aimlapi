...
// 场景图片生成由场景全景 prompt 控制：一张 16:9 横版 720 度全景空间参考图。
...
// 场景图片生成比例（16:9 横版 720 度全景空间参考图）
export const LOCATION_IMAGE_RATIO = '16:9'
// 场景图片尺寸（用于Seedream API）- 16:9 4K
