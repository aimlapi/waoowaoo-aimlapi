...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.SOUND_EFFECT_SCORE_PLAN]: 'progress.taskType.soundEffectScorePlan',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  sound_effect_score_prepare: 'progress.stage.soundEffectScorePrepare',
  sound_effect_score_plan: 'progress.stage.soundEffectScorePlan',
  sound_effect_score_generate_sound: 'progress.stage.soundEffectScoreGenerateSound',
  sound_effect_score_persist: 'progress.stage.soundEffectScorePersist',
