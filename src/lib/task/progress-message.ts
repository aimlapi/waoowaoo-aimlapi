...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.VISUAL_REFERENCE_CASES]: 'progress.taskType.visualReferenceCases',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  visual_reference_prepare: 'progress.stage.visualReferencePrepare',
  visual_reference_generate: 'progress.stage.visualReferenceGenerate',
  visual_reference_persist: 'progress.stage.visualReferencePersist',
