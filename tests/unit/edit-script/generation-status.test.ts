      ...
      text: JSON.stringify({
        screenplaySkeleton: {
          ...
          storyCoreEngine: {
            incitingIncident: {
              event: '静默空间站收到异常信号',
              beforeState: '操作员按流程值守',
              afterState: '操作员必须判断信号是否值得回应',
              actTurn: '从值守进入主动追踪',
            },
            globalGoal: {
              objective: '确认异常信号来源',
              measurableTarget: '锁定信号并完成回应选择',
              physicalProofOfSuccess: '发射阵列改变航向',
              deadlineOrConstraint: '生存系统即将关闭',
            },
            dramaticProblem: {
              problem: '回应信号可能牺牲空间站安全',
              whyItCannotBeIgnored: '不回应就可能放弃幸存者',
              howItLocksWithIncitingIncidentAndGoal: '异常信号迫使操作员把安全值守变成救援选择',
            },
            protagonistWound: {
              wound: '长期无人回应造成的自我怀疑',
              woundOrigin: '上一轮求救曾被误判为空噪',
              defensiveBelief: '不回应未知更安全',
              visibleBehavior: '反复确认读数才敢动作',
            },
            gearLock: '异常信号触发确认目标，旧误判伤口让回应选择变得危险。',
          },
          storyOriginDiagnosis: {
            primaryOrigin: 'concept',
            secondaryOrigin: 'character',
            rejectedOrigin: 'viewpoint',
            originReasoning: '异常信号机制是最强钩子',
            misdiagnosisRisk: '会变成普通孤独独白',
            derivationStrategy: '用信号压力推导人物选择',
            originDerivationChain: {
              startingSignal: '静默空间站收到信号',
              primaryQuestion: '信号如何制造不可退出压力',
              derivedExternalValueOpposition: { valueA1: '安全', valueB1: '救援', conflict: '安全与救援不能同时满足' },
              derivedInternalValueOpposition: { valueA2: '回应未知', valueB2: '维持沉默', conflict: '回应意味着再次承担误判代价', mutualExclusionTest: '一旦回应就否定沉默自保' },
              protagonistInference: {
                protagonistSeed: '空间站操作员',
                whyThisCharacter: '她掌握回应权限',
                whatTheyWant: '确认信号',
                whatTheyNeed: '承担回应未知的风险',
                whyTheyCannotAvoidThisStory: '信号进入她的值守系统',
                wound: {
                  wound: '长期无人回应造成的自我怀疑',
                  woundOrigin: '上一轮求救曾被误判为空噪',
                  defensiveBelief: '不回应未知更安全',
              ...
              disruptiveEventInference: {
                disruptiveEvent: '异常信号突破静默',
                whyThisEvent: '它直接挑战值守规则',
                howItForcesExternalGoal: '迫使她确认来源',
                howItActivatesInternalConflict: '唤起误判伤口',
              },
              contrastSystem: { mirrorCharacter: '空间站系统', contrastCharacter: '未知信号', worseFutureCharacter: '沉默的旧自己' },
              changeMechanism: { externalChange: '改变航向', internalChange: '选择回应', requiredAction: '接入备用电源', irreversibleCost: '牺牲原定安全轨道' },
              structuralImplication: { howToBuildValueMatrix: '安全与救援对赌', howToBuildCrisisMoment: '以生存系统倒计时逼选择', howToChooseStoryLocations: '集中在同一空间站控制区域', whatMustNotBeChangedLater: '不能变成无风险回应' },
            },
          },
          ...
          relationshipVoiceRules: [
            {
              fromCharacter: '操作员',
              toCharacter: '空间站系统',
              initialSocialDistance: '人机值守关系',
              addressRules: {},
              disclosureRules: {},
              forbiddenIntimacy: '禁止把系统写成亲密同伴',
              stageVoiceProgression: [{}],
            },
          ],
        },
      }),
      ...
      text: JSON.stringify({
        sceneLayerPackage: {
          sceneLayer: [
            {
              sceneNumber: 1,
              sceneLocationKey: 'INT|空间站控制舱|夜',
              intExt: '内景',
              locationName: '空间站控制舱',
              timeSpan: '夜',
              locationContinuity: '所有异常信号追踪都发生在同一控制舱内',
              sceneGoal: '确认信号来源',
              ...
              relationshipState: {
                ...
                stage: '人机对抗',
                socialDistance: '值守命令关系',
                trustLevel: '低信任',
                powerBalance: '系统暂时占优',
                knowledgeAsymmetry: '系统隐藏信号来源',
                allowedAddressMode: '冷静命令式',
                forbiddenRelationshipLeap: '禁止突然亲密化',
                relationshipTurn: '从服从系统转为反制系统',
              },
              dramaticPhases: [
                {
                  phaseNumber: 1,
                  ...
                  phaseFunction: '发现异常',
                  phaseGoal: '确认信号来源',
                  phaseAntagonist: '失控的空间站系统',
                  phaseOutcome: '操作员被迫进入核心舱',
                  turningPoint: '舱门从身后锁死',
                },
                {
                  phaseNumber: 2,
                  ...
                  phaseFunction: '回应信号',
                  phaseGoal: '决定是否回应信号',
                  phaseAntagonist: '即将关闭的生存系统',
                  phaseOutcome: '操作员回应信号并改变空间站航向',
              ...
              beats: [
                {
                  ...
                  actionReactionCouple: '试探 ↔ 逼迫',
	                  ...
	                  relationshipPressure: {
	                    currentStage: '人机值守关系被异常信号打破',
	                    pressureApplied: '系统用舱门锁死迫使操作员服从',
	                    trustMovement: '从低信任降为主动怀疑',
	                    powerMovement: '系统短暂夺走行动权',
	                    distanceMovement: '维持命令式人机距离',
	                    forbiddenLeapGuard: '禁止把系统写成亲密同伴或突然互相信任',
	                  },
	            ...
	            dialogueBeats: [
	              {
	                ...
	                relationshipExecution: {
	                  relationshipStage: '人机值守关系被异常信号打破',
	                  socialDistanceFit: '保持命令式人机距离',
	                  disclosureLimitFit: '只质疑信号，不倾诉私人创伤',
	                  intimacyLeapCheck: '没有把系统称作亲密对象',
	                },
	              },
	            ],
	          },
  ...
  it('generates screenplay for user review without starting style preview tasks', async () => {
    ...
    expect(prismaMock.projectEditScreenplay.upsert).toHaveBeenCalledWith(expect.objectContaining({
      create: expect.objectContaining({
        userPrompt: expect.stringContaining('剧本场景只按故事实际发生地点和时间段拆分'),
        screenplayText: '标题：《科幻短片》\n\n故事梗概：一条安静信号唤醒空间站。',
        status: 'screenplay_ready',
      }),
