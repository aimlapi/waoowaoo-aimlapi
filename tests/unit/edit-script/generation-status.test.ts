  ...
  characterVoiceEngine: [
    {
      ...
      localSpeechMarkers: [
        { standardExpression: '你', localExpression: '侬', usageContext: '急着压人或追问时使用', intensity: 'medium' },
        { standardExpression: '我', localExpression: '吾', usageContext: '放低姿态或自我辩解时使用', intensity: 'light' },
        { standardExpression: '不要', localExpression: '弗要', usageContext: '否定对方要求或阻止场面失控时使用', intensity: 'medium' },
      ],
    ...
    },
    {
      ...
      localSpeechMarkers: [
        { standardExpression: '我们', localExpression: '阿拉', usageContext: '把村里人情说成共同意见时使用', intensity: 'strong' },
        { standardExpression: '哪里', localExpression: '咸横', usageContext: '装糊涂或打听事由时使用', intensity: 'medium' },
        { standardExpression: '不知道', localExpression: '弗晓得', usageContext: '推责或含糊其辞时使用', intensity: 'medium' },
      ],
