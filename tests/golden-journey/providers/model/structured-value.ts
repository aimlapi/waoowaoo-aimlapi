  ...
  return {
    ...
    creativeDirection: {
      ...
      visual: {
        ...
        crossMediaStyle: 'Monochrome ink-wash illustration with restrained red accents across assets and motion.',
        ...
        assetImageStyle: {
          ...
          renderingRules: 'Preserve a clearly illustrated ink-on-paper result; never convert characters or environments into photography.',
        },
      },
