...
export const GOLDEN_SCENARIO_CONTRACTS = [
  {
    ...
    kind: 'freeform',
    title: 'natural language composes independent Resources with schema-projected card summaries, refresh-safe current Choice commitments, frozen adopted-Direction lineage, and explicitly adopted Chapters that become parallel Worker inputs',
